<template>
   <nav
      class="h-[80px] px-9 py-6 flex items-center justify-between fixed inset-x-0 z-50"
   >
      <Breadcrumb>
         <BreadcrumbList class="font-semibold">
            <BreadcrumbItem>
               <div class="home-logo bg-gray-200 h-6 aspect-square rounded">
                  <img
      ...
      <div class="account flex gap-x-2.5 items-center">
         <div class="avatar bg-gray-200 w-10 aspect-square rounded-lg">
            <img
               src="../assets//images/defaultAvt.webp"
               alt=""
            />
         </div>
