<template>
   <section class="dark:bg-gray-900 flex items-center justify-center m-16">
      <div
         class="w-full max-w-md p-6 my-10 bg-white rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
      >
         <h1
            class="text-xl font-bold text-gray-900 md:text-2xl dark:text-white text-center"
         >
            Đổi mật khẩu
         </h1>
         <form
               ...
               <div class="relative">
                  ...
                  >
                     <i
                        ...
                        class="fas fa-eye text-gray-600 dark:text-white"
                     ></i>
                     <i
                        v-else
                        class="fas fa-eye-slash text-gray-600 dark:text-white"
                     ></i>
                  </button>
               </div>
            </div>
