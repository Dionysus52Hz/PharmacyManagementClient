      ...
      <div>
         ...
         >
               ...
               <div class="flex items-center space-x-2 mt-4">
                  ...
                  <Popover>
                     <PopoverTrigger as-child>
                        <Button
                           variant="outline"
                           class="w-full mx-6 justify-start text-left font-normal"
                        >
                           {{
                              endDate
                                 ? formatDate(endDate)
            ...
            <TabsContent value="monthly">
               ...
               <StatisticMonthly
                  v-if="statisticMonthlyData"
                  :statisticMonthlyData="statisticMonthlyData"
               />
               <p
                  v-else
                  class="mt-4"
                  ...
                  >
                     <SelectTrigger>
                        <div
                           class="w-full p-0 text-left flex justify-between items-center cursor-pointer"
                           :class="
                              selectedQuarter ? 'text-black' : 'text-gray-500'
                           "
                        >
                           {{
                              selectedQuarter
            ...
            <TabsContent value="yearly">
               ...
               <StatisticYearly
                  v-if="statisticYearlyData"
                  :statisticYearlyData="statisticYearlyData"
               />
               <p
                  v-else
                  class="mt-4"
...
<script setup lang="ts">
   ...
   const fetchStatisticYear = async () => {
      ...
      try {
         ...
         const userToken = user.accessToken;
         const res = await fetch(
            `http://localhost:3001/api/statistic/year/?year=${selectedYear.value}`,
            {
               method: 'GET',
               headers: {
                  'Content-Type': 'application/json',
