        ...
        <div class="mx-6">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr v-for="note in statisticQuarterlyData.resultsInput" :key="note.received_note_id">
                            <th
                                scope="row"
            ...
            <div class="mt-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div class="grid grid-cols-3 gap-4">
                    <div class="flex items-center space-x-2 text-start">
                        ...
                        <p class="text-xl">{{ formatCurrency(statisticQuarterlyData.maxPriceRowInput.price || 0) }}</p>
                    </div>
                    <div class="flex items-center space-x-2 text-start">
                        <span class="text-lg font-semibold">Giá Thấp Nhất: </span>
                        <p class="text-xl">
                            {{ formatCurrency(statisticQuarterlyData.minPriceRowInput.price || 0) }}
                        </p>
                    </div>
                    <div class="flex items-center space-x-2 text-start">
                        <span class="text-lg font-semibold">Giá Trung Bình: </span>
                        <p class="text-xl">
                            {{ formatCurrency(statisticQuarterlyData.avgPriceInput || 0) }}
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="relative my-6 overflow-x-auto shadow-md sm:rounded-lg">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr v-for="note in statisticQuarterlyData.resultsOutput" :key="note.delivery_note_id">
                            <th
                                scope="row"
                                class="px-6 py-4 font-medium text-gray-900 whitespace-nowrap dark:text-white"
                            >
            ...
            <div class="mt-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div class="grid grid-cols-3 gap-4">
                    <div class="flex items-center space-x-2 text-start">
                        <span class="text-lg font-semibold">Giá Cao Nhất: </span>
                        <p class="text-xl">
                            <!-- {{ formatCurrency(statisticQuarterlyData.maxPriceRowOutput.price || 0) | currency }} -->
                            {{ formatCurrency(statisticQuarterlyData.maxPriceRowOutput.price || 0) }}
                        </p>
                    </div>
                    <div class="flex items-center space-x-2 text-start">
                        <span class="text-lg font-semibold">Giá Thấp Nhất: </span>
                        <p class="text-xl">
                            {{ formatCurrency(statisticQuarterlyData.minPriceRowOutput.price || 0) }}
                        </p>
                    </div>
                    <div class="flex items-center space-x-2 text-start">
                        <span class="text-lg font-semibold">Giá Trung Bình: </span>
                        <p class="text-xl">
                            {{ formatCurrency(statisticQuarterlyData.avgPriceOutput || 0) }}
                        </p>
                    </div>
                </div>
            </div>
            <div class="mt-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                <div class="grid grid-cols-3 gap-4">
                    <div class="flex items-center space-x-2 text-start">
                        ...
                        <p class="text-xl">
                            {{ formatCurrency(statisticQuarterlyData.totalPriceInput || 0) }}
                        </p>
                    </div>
                    <div class="flex items-center space-x-2 text-start">
                        <span class="text-lg font-semibold">Tổng chi: </span>
                        <p class="text-xl">
                            {{ formatCurrency(statisticQuarterlyData.totalPriceOutput || 0) }}
                        </p>
                    </div>
                    <div class="flex items-center space-x-2 text-start">
                        <span class="text-lg font-semibold">Lợi nhuận: </span>
                        <p class="text-xl">
                            {{ formatCurrency(statisticQuarterlyData.totalProfit || 0) }}
                        </p>
                    </div>
                </div>
            </div>
...
onMounted(() => {
    console.log('statisticQuarterlyData: ', props.statisticQuarterlyData);
    console.log(
        ' {{ statisticQuarterlyData.maxPriceRowOutput.price }}: ',
        props.statisticQuarterlyData.maxPriceRowOutput.price,
    );
});
</script>
