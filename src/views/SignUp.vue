<template>
    <div class="grid grid-cols-2 gap-x-4 h-fit pt-[52px]">
        <div class="photo w-[500px] h-full rounded-lg place-self-end flex items-center">
            <img src="../assets/images/Signup.png" alt="" class="object-cover" />
        </div>
                ...
                <form class="w-full space-y-6" @submit="onSubmit">
                    ...
                    <FormField v-slot="{ componentField }" name="fullname">
                        <FormItem v-auto-animate>
                            ...
                            <FormControl>
                                <Input type="text" placeholder="Nhập họ và tên" v-bind="componentField" />
                            </FormControl>
                    ...
                    <FormField v-slot="{ componentField }" name="address">
                        <FormItem v-auto-animate>
                            ...
                            <FormControl>
                                <Input type="text" placeholder="Nhập địa chỉ" v-bind="componentField" />
                            </FormControl>
...
const formSchema = toTypedSchema(
    z.object({
        ...
        phoneNumber: z.string({ required_error: 'Số điện thoại không thể để trống' }).regex(/^0[3579]\d{8}$/, {
            message: 'Số điện thoại không hợp lệ (phải bắt đầu bằng 0 và số thứ 2 là 3, 5, 7 hoặc 9)',
        }),
    }),
);
